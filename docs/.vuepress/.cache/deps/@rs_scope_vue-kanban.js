...
// node_modules/.pnpm/@rs_scope+vue-kanban@0.0.4_@types+node@22.5.5_rollup@4.22.4_sortablejs@1.15.3_typescript@5.4._4tk5jstd7migawxhxj3qotmqje/node_modules/@rs_scope/vue-kanban/dist/vue-kanban.es.js
(function() {
  "use strict";
  var r;
  try {
...
Ye.WORDS = void 0;
var Qn = ["ad", "adipisicing", "aliqua", "aliquip", "amet", "anim", "aute", "cillum", "commodo", "consectetur", "consequat", "culpa", "cupidatat", "deserunt", "do", "dolor", "dolore", "duis", "ea", "eiusmod", "elit", "enim", "esse", "est", "et", "eu", "ex", "excepteur", "exercitation", "fugiat", "id", "in", "incididunt", "ipsum", "irure", "labore", "laboris", "laborum", "Lorem", "magna", "minim", "mollit", "nisi", "non", "nostrud", "nulla", "occaecat", "officia", "pariatur", "proident", "qui", "quis", "reprehenderit", "sint", "sit", "sunt", "tempor", "ullamco", "ut", "velit", "veniam", "voluptate"];
Ye.WORDS = Qn;
var Jt = {};
var et = {};
...
(function(n) {
  ...
  var e = A(Lt), t = A(Bn), r = A(_t), i = A($t), a = A(zt), o = A(en);
  function A(u) {
...
(function(n) {
  ...
  function a(d, s, l) {
    return s && i(d.prototype, s), Object.defineProperty(d, "prototype", { writable: false }), d;
  }
  function o(d, s, l) {
    return s in d ? Object.defineProperty(d, s, { value: l, enumerable: true, configurable: true, writable: true }) : d[s] = l, d;
  }
  var A = function() {
    function d() {
      var s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, l = s.sentencesPerParagraph, f = l === void 0 ? {
        max: 7,
        min: 3
      } : l, E = s.wordsPerSentence, v = E === void 0 ? {
        max: 15,
        min: 5
      } : E, c = s.random;
      s.seed;
      var R = s.words, q = R === void 0 ? e.WORDS : R;
      if (r(this, d), o(this, "sentencesPerParagraph", void 0), o(this, "wordsPerSentence", void 0), o(this, "random", void 0), o(this, "words", void 0), f.min > f.max)
    ...
    return a(d, [{
      ...
      value: function(l, f) {
        return Math.floor(this.random() * (f - l + 1) + l);
      }
    }, {
      key: "generateRandomWords",
      value: function(l) {
        var f = this, E = this.wordsPerSentence, v = E.min, c = E.max, R = l || this.generateRandomInteger(v, c);
      ...
      value: function(l) {
        return "".concat((0, t.capitalize)(this.generateRandomWords(l)), ".");
      }
    }, {
      key: "generateRandomParagraph",
      value: function(l) {
        var f = this, E = this.sentencesPerParagraph, v = E.min, c = E.max, R = l || this.generateRandomInteger(v, c);
        return (0, t.makeArrayOfLength)(R).reduce(function(q, y) {
      ...
      key: "pluckRandomWord",
      value: function() {
        var l = 0, f = this.words.length - 1, E = this.generateRandomInteger(l, f);
        return this.words[E];
      }
    }]), d;
  }(), u = A;
...
(function(n) {
  ...
  function u(f, E, v) {
    return E && A(f.prototype, E), Object.defineProperty(f, "prototype", { writable: false }), f;
  }
  function d(f, E, v) {
  ...
  var s = function() {
    function f() {
      ...
      if (o(this, f), this.format = v, this.suffix = c, d(this, "generator", void 0), e.FORMATS.indexOf(v.toLowerCase()) === -1)
...
(function(n) {
  ...
  var o = function() {
    ...
    }, w = new i.default(se, f, J);
    switch ($) {
      case t.UNIT_PARAGRAPHS:
      case t.UNIT_PARAGRAPH:
        return w.generateParagraphs(s);
      case t.UNIT_SENTENCES:
      case t.UNIT_SENTENCE:
        return w.generateSentences(s);
      case t.UNIT_WORDS:
      case t.UNIT_WORD:
        return w.generateWords(s);
      default:
        return "";
    }
  };
...
var wn = { class: "app-card-priority" };
var Un = {
  key: 0,
...
var Pn = defineComponent({
  ...
  setup(n) {
    return (e, t) => (openBlock(), createElementBlock("div", wn, [
      ...
      e.priority === "Medium" ? (openBlock(), createElementBlock("div", Kn, [
        createBaseVNode("div", null, toDisplayString(e.priority), 1),
      ...
      e.priority === "High" ? (openBlock(), createElementBlock("div", Fn, [
        createBaseVNode("div", null, toDisplayString(e.priority), 1),
...
function Z(n, e, t, r, i) {
  if (!(!n.getBoundingClientRect && n !== window)) {
    var a, o, A, u, d, s, l;
    if (n !== window && n.parentNode && n !== H() ? (a = n.getBoundingClientRect(), o = a.top, A = a.left, u = a.bottom, d = a.right, s = a.height, l = a.width) : (o = 0, A = 0, u = window.innerHeight, d = window.innerWidth, s = window.innerHeight, l = window.innerWidth), (e || t) && n !== window && (i = i || n.parentNode, !ie))
      do
        if (i && i.getBoundingClientRect && (m(i, "transform") !== "none" || t && m(i, "position") !== "static")) {
          var f = i.getBoundingClientRect();
          o -= f.top + parseInt(m(i, "border-top-width")), A -= f.left + parseInt(m(i, "border-left-width")), u = o + a.height, d = A + a.width;
          break;
        }
      while (i = i.parentNode);
    if (r && n !== window) {
      var E = ze(i || n), v = E && E.a, c = E && E.d;
      E && (o /= c, A /= v, l /= v, s /= c, u = o + s, d = A + l);
    }
    return {
      top: o,
      left: A,
...
function be(n, e, t, r) {
  for (var i = 0, a = 0, o = n.children; a < o.length; ) {
    if (o[a].style.display !== "none" && o[a] !== I.ghost && (r || o[a] !== I.dragged) && G(o[a], t.draggable, n, false)) {
      if (i === e)
        return o[a];
      i++;
    }
...
function dn(n, e, t) {
  ...
  return Array.from(n.children).forEach(function(i) {
    ...
    if (!(!G(i, e.draggable, n, false) || i.animated || i === t)) {
      var d = Z(i);
      r.left = Math.min((a = r.left) !== null && a !== void 0 ? a : 1 / 0, d.left), r.top = Math.min((o = r.top) !== null && o !== void 0 ? o : 1 / 0, d.top), r.right = Math.max((A = r.right) !== null && A !== void 0 ? A : -1 / 0, d.right), r.bottom = Math.max((u = r.bottom) !== null && u !== void 0 ? u : -1 / 0, d.bottom);
    }
  ...
  return {
    ...
    animateAll: function(r) {
      ...
      n.forEach(function(A) {
        var u = 0, d = A.target, s = d.fromRect, l = Z(d), f = d.prevFromRect, E = d.prevToRect, v = A.rect, c = ze(d, true);
        c && (l.top -= c.f, l.left -= c.e), d.toRect = l, d.thisAnimationDuration && rt(f, l) && !rt(s, l) && // Make sure animatingRect is on line between toRect & fromRect
        (v.top - l.top) / (v.left - l.left) === (s.top - l.top) / (s.left - l.left) && (u = nr(v, f, E, i.options)), rt(l, s) || (d.prevFromRect = s, d.prevToRect = l, u || (u = i.options.animation), i.animate(d, v, l, u)), u && (a = true, o = Math.max(o, u), clearTimeout(d.animationResetTimer), d.animationResetTimer = setTimeout(function() {
    ...
    animate: function(r, i, a, o) {
      if (o) {
        ...
        var A = ze(this.el), u = A && A.a, d = A && A.d, s = (i.left - a.left) / (u || 1), l = (i.top - a.top) / (d || 1);
        r.animatingX = !!s, r.animatingY = !!l, m(r, "transform", "translate3d(" + s + "px," + l + "px,0)"), this.forRepaintDummy = tr(r), m(r, "transition", "transform " + o + "ms" + (this.options.easing ? " " + this.options.easing : "")), m(r, "transform", "translate3d(0,0,0)"), typeof r.animated == "number" && clearTimeout(r.animated), r.animated = setTimeout(function() {
...
var Ne = {
  ...
  pluginEvent: function(e, t, r) {
    ...
    ce.forEach(function(o) {
      t[o.pluginName] && (t[o.pluginName][a] && t[o.pluginName][a](L({
        sortable: t
      }, r)), t.options[o.pluginName] && t[o.pluginName][e] && t[o.pluginName][e](L({
        sortable: t
      }, r)));
    });
  },
  initializePlugins: function(e, t, r, i) {
    ce.forEach(function(A) {
      ...
      if (!(!e.options[u] && !A.initializeByDefault)) {
        var d = new A(e, t, e.options);
        d.sortable = e, d.options = e.options, e[u] = d, re(r, d.defaults);
      }
    });
...
function rr(n) {
  var e = n.sortable, t = n.rootEl, r = n.name, i = n.targetEl, a = n.cloneEl, o = n.toEl, A = n.fromEl, u = n.oldIndex, d = n.newIndex, s = n.oldDraggableIndex, l = n.newDraggableIndex, f = n.originalEvent, E = n.putSortable, v = n.extraEventProperties;
  if (e = e || t && t[T], !!e) {
    var c, R = e.options, q = "on" + r.charAt(0).toUpperCase() + r.substr(1);
    window.CustomEvent && !ie && !Se ? c = new CustomEvent(r, {
      bubbles: true,
      cancelable: true
    }) : (c = document.createEvent("Event"), c.initEvent(r, true, true)), c.to = o || t, c.from = A || t, c.item = i || t, c.clone = a, c.oldIndex = u, c.newIndex = d, c.oldDraggableIndex = s, c.newDraggableIndex = l, c.originalEvent = f, c.pullMode = E ? E.lastPutMode : void 0;
...
var ir = ["evt"];
var N = function(e, t) {
  var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, i = r.evt, a = Jn(r, ir);
...
var ar = nt && !nn && !tn && "draggable" in document.createElement("div");
var sn = function() {
  if (nt) {
    if (ie)
      return false;
...
var fn = function(e, t) {
  var r = m(e), i = parseInt(r.width) - parseInt(r.paddingLeft) - parseInt(r.paddingRight) - parseInt(r.borderLeftWidth) - parseInt(r.borderRightWidth), a = be(e, 0, t), o = be(e, 1, t), A = a && m(a), u = o && m(o), d = A && parseInt(A.marginLeft) + parseInt(A.marginRight) + Z(a).width, s = u && parseInt(u.marginLeft) + parseInt(u.marginRight) + Z(o).width;
  if (r.display === "flex")
    return r.flexDirection === "column" || r.flexDirection === "column-reverse" ? "vertical" : "horizontal";
  if (r.display === "grid")
    return r.gridTemplateColumns.split(" ").length <= 1 ? "vertical" : "horizontal";
  if (a && A.float && A.float !== "none") {
    var l = A.float === "left" ? "left" : "right";
    return o && (u.clear === "both" || u.clear === l) ? "vertical" : "horizontal";
  }
  return a && (A.display === "block" || A.display === "flex" || A.display === "table" || A.display === "grid" || d >= i && r[Vt] === "none" || o && r[Vt] === "none" && d + s > i) ? "vertical" : "horizontal";
};
var or = function(e, t, r) {
  var i = r ? e.left : e.top, a = r ? e.right : e.bottom, o = r ? e.width : e.height, A = r ? t.left : t.top, u = r ? t.right : t.bottom, d = r ? t.width : t.height;
  return i === A || a === u || i + o / 2 === A + d / 2;
};
var Ar = function(e, t) {
  var r;
  return Le.some(function(i) {
    ...
    if (!(!a || bt(i))) {
      var o = Z(i), A = e >= o.left - a && e <= o.right + a, u = t >= o.top - a && t <= o.bottom + a;
      if (A && u)
        return r = i;
    }
  }), r;
...
var gn = function(e) {
  function t(a, o) {
    return function(A, u, d, s) {
      var l = A.options.group.name && u.options.group.name && A.options.group.name === u.options.group.name;
      if (a == null && (o || l))
        return true;
      if (a == null || a === false)
        return false;
      ...
      if (typeof a == "function")
        return t(a(A, u, d, s), o)(A, u, d, s);
      var f = (o ? A : u).options.group.name;
...
I.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTapStart: function(e) {
    if (e.cancelable) {
      var t = this, r = this.el, i = this.options, a = i.preventOnFilter, o = e.type, A = e.touches && e.touches[0] || e.pointerType && e.pointerType === "touch" && e, u = (A || e).target, d = e.target.shadowRoot && (e.path && e.path[0] || e.composedPath && e.composedPath()[0]) || u, s = i.filter;
      if (cr(r), !g && !(/mousedown|pointerdown/.test(o) && e.button !== 0 || i.disabled) && !d.isContentEditable && !(!this.nativeDraggable && Oe && u && u.tagName.toUpperCase() === "SELECT") && (u = G(u, i.draggable, r, false), !(u && u.animated) && Fe !== u)) {
        ...
        } else if (s && (s = s.split(",").some(function(l) {
          if (l = G(d, l.trim(), r, false), l)
            return S({
              sortable: t,
              rootEl: l,
              name: "filter",
        ...
        i.handle && !G(d, i.handle, r, false) || this._prepareDragStart(e, A, u);
      }
    }
  },
  _prepareDragStart: function(e, t, r) {
    var i = this, a = i.el, o = i.options, A = a.ownerDocument, u;
    if (r && !g && r.parentNode === a) {
      var d = Z(r);
      if (b = a, g = r, M = g.parentNode, Ee = g.nextSibling, Fe = r, We = o.group, I.dragged = g, ge = {
        target: g,
        clientX: (t || e).clientX,
        clientY: (t || e).clientY
      }, kt = ge.clientX - d.left, Dt = ge.clientY - d.top, this._lastX = (t || e).clientX, this._lastY = (t || e).clientY, g.style["will-change"] = "all", u = function() {
        if (N("delayEnded", i, {
          evt: e
        }), I.eventCanceled) {
          i._onDrop();
        ...
        i._disableDelayedDragEvents(), !Bt && i.nativeDraggable && (g.draggable = true), i._triggerDragStart(e, t), S({
          ...
          name: "choose",
          originalEvent: e
        }), U(g, o.chosenClass, true);
      }, o.ignore.split(",").forEach(function(s) {
        on(g, s.trim(), ut);
      }), z(A, "dragover", ve), z(A, "mousemove", ve), z(A, "touchmove", ve), z(A, "mouseup", i._onDrop), z(A, "touchend", i._onDrop), z(A, "touchcancel", i._onDrop), Bt && this.nativeDraggable && (this.options.touchStartThreshold = 4, g.draggable = true), N("delayStart", this, {
        evt: e
      }), o.delay && (!o.delayOnTouchOnly || t) && (!this.nativeDraggable || !(Se || ie))) {
        if (I.eventCanceled) {
          this._onDrop();
          return;
        }
        z(A, "mouseup", i._disableDelayedDrag), z(A, "touchend", i._disableDelayedDrag), z(A, "touchcancel", i._disableDelayedDrag), z(A, "mousemove", i._delayedDragTouchMoveHandler), z(A, "touchmove", i._delayedDragTouchMoveHandler), o.supportPointer && z(A, "pointermove", i._delayedDragTouchMoveHandler), i._dragStartTimer = setTimeout(u, o.delay);
      } else
        u();
    }
  },
  ...
  _dragStarted: function(e, t) {
    if (Ie = false, b && g) {
      N("dragStarted", this, {
        evt: t
      }), this.nativeDraggable && z(document, "dragover", ur);
      var r = this.options;
      !e && U(g, r.dragClass, false), U(g, r.ghostClass, true), I.active = this, e && this._appendGhost(), S({
        sortable: this,
        name: "start",
        originalEvent: t
      });
  ...
  _onTouchMove: function(e) {
    if (ge) {
      var t = this.options, r = t.fallbackTolerance, i = t.fallbackOffset, a = e.touches ? e.touches[0] : e, o = p && ze(p, true), A = p && o && o.a, u = p && o && o.d, d = we && k && Xt(k), s = (a.clientX - ge.clientX + i.x) / (A || 1) + (d ? d[0] - At[0] : 0) / (A || 1), l = (a.clientY - ge.clientY + i.y) / (u || 1) + (d ? d[1] - At[1] : 0) / (u || 1);
      if (!I.active && !Ie) {
      ...
      if (p) {
        ...
        m(p, "webkitTransform", f), m(p, "mozTransform", f), m(p, "msTransform", f), m(p, "transform", f), at = s, ot = l, x = a;
      }
  ...
  _appendGhost: function() {
    if (!p) {
      var e = this.options.fallbackOnBody ? document.body : b, t = Z(g, true, we, true, e), r = this.options;
      if (we) {
        for (k = e; m(k, "position") === "static" && m(k, "transform") === "none" && k !== document; )
          k = k.parentNode;
        k !== document.body && k !== document.documentElement ? (k === document && (k = H()), t.top += k.scrollTop, t.left += k.scrollLeft) : k = H(), At = Xt(k);
      }
      p = g.cloneNode(true), U(p, r.ghostClass, false), U(p, r.fallbackClass, true), U(p, r.dragClass, true), m(p, "transition", ""), m(p, "transform", ""), m(p, "box-sizing", "border-box"), m(p, "margin", 0), m(p, "top", t.top), m(p, "left", t.left), m(p, "width", t.width), m(p, "height", t.height), m(p, "opacity", "0.8"), m(p, "position", we ? "absolute" : "fixed"), m(p, "zIndex", "100000"), m(p, "pointerEvents", "none"), I.ghost = p, e.appendChild(p), m(p, "transform-origin", kt / parseInt(p.style.width) * 100 + "% " + Dt / parseInt(p.style.height) * 100 + "%");
    }
  },
  _onDragStart: function(e, t) {
    ...
    N("setupClone", this), I.eventCanceled || (C = ln(g), C.removeAttribute("id"), C.draggable = false, C.style["will-change"] = "", this._hideClone(), U(C, this.options.chosenClass, false), I.clone = C), r.cloneId = xe(function() {
  ...
  _onDragOver: function(e) {
    var t = this.el, r = e.target, i, a, o, A = this.options, u = A.group, d = I.active, s = We === u, l = A.sort, f = O || d, E, v = this, c = false;
    if (Et) return;
    function R(Me, mn) {
      N(Me, v, L({
        evt: e,
        ...
        target: r,
        completed: y,
        onMove: function(Mt, In) {
          return Ue(b, t, g, i, Mt, Z(Mt), e, In);
        },
        changed: W
      }, mn));
    }
    ...
    function y(Me) {
      return R("dragOverCompleted", {
        insertion: Me
      }), Me && (s ? d._hideClone() : d._showClone(v), v !== f && (U(g, O ? O.options.ghostClass : d.options.ghostClass, false), U(g, A.ghostClass, true)), O !== v && v !== I.active ? O = v : v === I.active && O && (O = null), f === v && (v._ignoreWhileAnimating = r), v.animateAll(function() {
        R("dragOverAnimationComplete"), v._ignoreWhileAnimating = null;
      }), v !== f && (f.animateAll(), f._ignoreWhileAnimating = null)), (r === g && !g.animated || r === t && !r.animated) && (me = null), !A.dragoverBubble && !e.rootEl && r !== document && (g.parentNode[T]._isOutsideThisEl(e.target), !Me && ve(e)), !A.dragoverBubble && e.stopPropagation && e.stopPropagation(), c = true;
    }
    function W() {
      K = P(g), ue = P(g, A.draggable), S({
        sortable: v,
        name: "change",
        toEl: t,
        newIndex: K,
    ...
    if (e.preventDefault !== void 0 && e.cancelable && e.preventDefault(), r = G(r, A.draggable, t, true), R("dragOver"), I.eventCanceled) return c;
    if (g.contains(e.target) || r.animated && r.animatingX && r.animatingY || v._ignoreWhileAnimating === r)
      return y(false);
    if (He = false, d && !A.disabled && (s ? l || (o = M !== b) : O === this || (this.lastPutMode = We.checkPull(this, d, g, e)) && u.checkPut(this, d, g, e))) {
      ...
      var X = bt(t, A.draggable);
      if (!X || fr(e, E, this) && !X.animated) {
        if (X === g)
          return y(false);
        if (X && t === e.target && (r = X), r && (a = Z(r)), Ue(b, t, g, i, r, a, e, !!r) !== false)
          return q(), X && X.nextSibling ? t.insertBefore(g, X.nextSibling) : t.appendChild(g), M = t, W(), y(true);
      } else if (X && sr(e, E, this)) {
        var _ = be(t, 0, A, true);
        if (_ === g)
          return y(false);
        if (r = _, a = Z(r), Ue(b, t, g, i, r, a, e, false) !== false)
          return q(), t.insertBefore(g, _), M = t, W(), y(true);
      } else if (r.parentNode === t) {
        a = Z(r);
        var j = 0, $, ae = g.parentNode !== t, Y = !or(g.animated && g.toRect || i, r.animated && r.toRect || a, E), oe = E ? "top" : "left", J = Ot(r, "top", "top") || Ot(g, "top", "top"), se = J ? J.scrollTop : void 0;
        me !== r && ($ = a[oe], Ve = false, je = !Y && A.invertSwap || ae), j = gr(e, r, a, E, Y ? 1 : A.swapThreshold, A.invertedSwapThreshold == null ? A.swapThreshold : A.invertedSwapThreshold, je, me === r);
        var w;
        if (j !== 0) {
          var fe = P(g);
          do
            fe -= j, w = M.children[fe];
          while (w && (m(w, "display") === "none" || w === p));
        }
        if (j === 0 || w === r)
          return y(false);
        me = r, De = j;
        ...
        Ae = j === 1;
        var Te = Ue(b, t, g, i, r, a, e, Ae);
        if (Te !== false)
          return (Te === 1 || Te === -1) && (Ae = Te === 1), Et = true, setTimeout(dr, 30), q(), Ae && !Re ? t.appendChild(g) : r.parentNode.insertBefore(g, Ae ? Re : r), J && un(J, 0, se - J.scrollTop), M = g.parentNode, $ !== void 0 && !je && (Pe = Math.abs($ - Z(r)[oe])), W(), y(true);
      }
      if (t.contains(g))
        return y(false);
    }
   ...
   */
  toArray: function() {
    for (var e = [], t, r = this.el.children, i = 0, a = r.length, o = this.options; i < a; i++)
      t = r[i], G(t, o.draggable, this.el, false) && e.push(t.getAttribute(o.dataIdAttr) || Er(t));
    return e;
  },
  /**
  ...
  sort: function(e, t) {
    ...
    this.toArray().forEach(function(a, o) {
      var A = i.children[o];
      G(A, this.options.draggable, i, false) && (r[a] = A);
...
function Ue(n, e, t, r, i, a, o, A) {
  var u, d = n[T], s = d.options.onMove, l;
  return window.CustomEvent && !ie && !Se ? u = new CustomEvent("move", {
    bubbles: true,
    cancelable: true
  }) : (u = document.createEvent("Event"), u.initEvent("move", true, true)), u.to = e, u.from = n, u.dragged = t, u.draggedRect = r, u.related = i || e, u.relatedRect = a || Z(e), u.willInsertAfter = A, u.originalEvent = o, n.dispatchEvent(u), s && (l = s.call(d, u, o)), l;
}
function ut(n) {
  n.draggable = false;
}
...
function fr(n, e, t) {
  var r = Z(bt(t.el, t.options.draggable)), i = dn(t.el, t.options, p), a = 10;
  return e ? n.clientX > i.right + a || n.clientY > r.bottom && n.clientX > r.left : n.clientY > i.bottom + a || n.clientX > r.right && n.clientY > r.top;
}
function gr(n, e, t, r, i, a, o, A) {
  var u = r ? n.clientY : n.clientX, d = r ? t.height : t.width, s = r ? t.top : t.left, l = r ? t.bottom : t.right, f = false;
  if (!o) {
    if (A && Pe < d * i) {
      if (!Ve && (De === 1 ? u > s + d * a / 2 : u < l - d * a / 2) && (Ve = true), Ve)
        f = true;
      else if (De === 1 ? u < s + Pe : u > l - Pe)
        return -De;
    } else if (u > s + d * (1 - i) / 2 && u < l - d * (1 - i) / 2)
      return vr(e);
  }
  return f = f || o, f && (u < s + d * a / 2 || u > l - d * a / 2) ? u > s + d / 2 ? 1 : -1 : 0;
}
function vr(n) {
  return P(g) < P(n) ? 1 : -1;
}
...
function mr() {
  ...
  return n.prototype = {
    ...
    drop: function() {
      this.sortable.nativeDraggable ? h(document, "dragover", this._handleAutoScroll) : (h(document, "pointermove", this._handleFallbackAutoScroll), h(document, "touchmove", this._handleFallbackAutoScroll), h(document, "mousemove", this._handleFallbackAutoScroll)), Yt(), Ge(), $n();
    },
    nulling: function() {
      $e = mt = Qe = It = Ze = lt = dt = null, Q.length = 0;
    },
    _handleFallbackAutoScroll: function(t) {
      this._handleAutoScroll(t, true);
    },
    _handleAutoScroll: function(t, r) {
      var i = this, a = (t.touches ? t.touches[0] : t).clientX, o = (t.touches ? t.touches[0] : t).clientY, A = document.elementFromPoint(a, o);
      if ($e = t, r || this.options.forceAutoScrollFallback || Se || ie || Oe) {
        st(t, this.options, A, r);
        var u = de(A, true);
        It && (!Ze || a !== lt || o !== dt) && (Ze && Yt(), Ze = setInterval(function() {
          var d = de(document.elementFromPoint(a, o), true);
          d !== u && (u = d, Ge()), st(t, i.options, d, r);
        }, 10), lt = a, dt = o);
      } else {
        if (!this.options.bubbleScroll || de(A, true) === H()) {
          Ge();
          return;
        }
        st(t, this.options, de(A, false), false);
      }
    }
  }, re(n, {
    pluginName: "scroll",
...
var st = An(function(n, e, t, r) {
  if (e.scroll) {
    var i = (n.touches ? n.touches[0] : n).clientX, a = (n.touches ? n.touches[0] : n).clientY, o = e.scrollSensitivity, A = e.scrollSpeed, u = H(), d = false, s;
    mt !== t && (mt = t, Ge(), Qe = e.scroll, s = e.scrollFn, Qe === true && (Qe = de(t, true)));
    var l = 0, f = Qe;
    do {
      ...
      var se = _ && (Math.abs(y - i) <= o && oe + W < $) - (Math.abs(q - i) <= o && !!oe), w = j && (Math.abs(R - a) <= o && J + X < ae) - (Math.abs(c - a) <= o && !!J);
      if (!Q[l])
        for (var fe = 0; fe <= l; fe++)
          Q[fe] || (Q[fe] = {});
      (Q[l].vx != se || Q[l].vy != w || Q[l].el !== E) && (Q[l].el = E, Q[l].vx = se, Q[l].vy = w, clearInterval(Q[l].pid), (se != 0 || w != 0) && (d = true, Q[l].pid = setInterval((function() {
        r && this.layer === 0 && I.active._onTouchMove($e);
        var Re = Q[this.layer].vy ? Q[this.layer].vy * A : 0, Ae = Q[this.layer].vx ? Q[this.layer].vx * A : 0;
...
var cn = function(e) {
  var t = e.originalEvent, r = e.putSortable, i = e.dragEl, a = e.activeSortable, o = e.dispatchSortableEvent, A = e.hideGhostForTarget, u = e.unhideGhostForTarget;
  if (t) {
    var d = r || a;
    A();
    var s = t.changedTouches && t.changedTouches.length ? t.changedTouches[0] : t, l = document.elementFromPoint(s.clientX, s.clientY);
    u(), d && !d.el.contains(l) && (o("spill"), this.onSpill({
      dragEl: i,
      putSortable: r
    }));
  }
...
var Ir = defineComponent({
  ...
  setup(n, { expose: e, emit: t }) {
    const r = n, i = t, a = useAttrs(), o = ref(false), A = ref(null), u = ref(null), d = computed(() => typeof r.itemKey == "string" ? (s) => s[r.itemKey] : r.itemKey);
    return e({
      containerRef: A,
      sortable: u,
      isDragging: o
      ...
      s && (u.value = new I(s, {
        ...r.options,
        onChoose: (l) => i("choose", l),
        onUnchoose: (l) => i("unchoose", l),
        onStart: (l) => {
          o.value = true, i("start", l);
        },
        onEnd: (l) => {
          setTimeout(() => {
            o.value = false, i("end", l);
          });
        },
        onAdd: (l) => i("add", l),
        onUpdate: (l) => i("update", l),
        onSort: (l) => i("sort", l),
        onRemove: (l) => i("remove", l),
        onFilter: (l) => i("filter", l),
        // See https://github.com/MaxLeiter/sortablejs-vue3/pull/56 for context on `attrs`.
        onMove: (l, f) => "onMoveCapture" in a ? (
          /**  eslint-disable-next-line */
          a.onMoveCapture(l, f)
        ) : i("move", l, f),
        onClone: (l) => i("clone", l),
        onChange: (l) => i("change", l)
      }));
    }), watch(
      () => r.options,
      (s) => {
      ...
      u.value && (u.value.destroy(), A.value = null, u.value = null);
    }), (s, l) => (openBlock(), createBlock(resolveDynamicComponent(s.$props.tag), {
...
function pr(n, e) {
  ...
  function a(o) {
    const A = {
      elemIndexFrom: o.oldIndex,
      elemIndexTo: o.newIndex,
      columnIndexFrom: void 0,
      columnIndexTo: void 0,
      dataSet: n
    };
    if (o.from.dataset.indexColumn && o.to.dataset.indexColumn) {
      A.columnIndexFrom = parseInt(o.from.dataset.indexColumn), A.columnIndexTo = parseInt(o.to.dataset.indexColumn);
      const u = n.columns[A.columnIndexFrom], d = n.columns[A.columnIndexTo];
      if (A.elemIndexFrom !== void 0 && A.elemIndexTo !== void 0) {
        const s = i(u.items, A.elemIndexFrom);
        r(d.items, s[0], A.elemIndexTo), A.dataSet = n, t.value++;
      }
    }
    e("update", A);
  }
...
var hr = { class: "vue-kanban-header" };
var zr = defineComponent({
  __name: "VueKanbanHeader",
  props: {
    column: {}
  },
  setup(n) {
...
var br = { class: "vue-kanban-item" };
var Cr = { key: 0 };
var Rr = defineComponent({
  __name: "VueKanbanItem",
  props: {
    element: {}
  },
  setup(n) {
    return (e, t) => (openBlock(), createElementBlock("div", br, [
      createBaseVNode("div", null, toDisplayString(e.element.id), 1),
      e.element.value ? (openBlock(), createElementBlock("div", Cr, toDisplayString(e.element.value), 1)) : createCommentVNode("", true)
    ]));
  }
});
var Mr = defineComponent({
  ...
  emits: ["update"],
  setup(n, { emit: e }) {
    const t = n, r = e, { updateData: i } = pr(t, r), a = ref();
    return (o, A) => (openBlock(), createElementBlock("div", {
      ref_key: "kanbanRef",
      ref: a,
      class: "vue-kanban"
    }, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(t.columns, (u, d, s) => (openBlock(), createElementBlock("div", {
        key: s,
        ...
        o.$.slots.header ? renderSlot(o.$slots, "header", {
          key: 0,
          column: u
        }) : (openBlock(), createBlock(zr, {
          key: 1,
          column: u
        }, null, 8, ["column"])),
        createVNode(unref(Ir), {
          ref_for: true,
          ref: "sortable",
          ...
          item: withCtx(({ element: l }) => [
            o.$.slots.item ? renderSlot(o.$slots, "item", {
              key: 0,
              elem: l
            }) : (openBlock(), createBlock(Rr, {
              key: 1,
              element: l
            }, null, 8, ["element"]))
          ]),
...
var yr = { class: "wrapp" };
var Qr = { class: "app-card" };
var Zr = { class: "app-card-header" };
var Br = { class: "app-card-task" };
var qr = { class: "app-card-bottom" };
var Or = { class: "app-card-footer" };
var Xr = { class: "app-card-branch" };
var kr = ["src"];
var Yr = defineComponent({
  ...
  setup(n) {
    ...
    return (a, o) => (openBlock(), createElementBlock("div", yr, [
      createVNode(Mr, {
        columns: toRaw(t(3, 3)),
        options: r.value,
        onUpdate: i
          ...
          (openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", Qr, [
              createBaseVNode("div", Zr, [
                ...
                createBaseVNode("div", Br, toDisplayString(A.task), 1)
              ]),
              createBaseVNode("div", qr, [
                createVNode(Pn, {
                  priority: A.priority
                ...
                createBaseVNode("div", Or, [
                  createBaseVNode("div", Xr, toDisplayString(A.branch), 1),
                  createBaseVNode("img", {
